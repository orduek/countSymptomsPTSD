...
sapply(dfPCL5, class)
countCon <- plyr::count(dfPCL5)
#dfPCL5 <- dfPCL5 %>% mutate_if(is.numeric,as.character)
# join the two so we have frequency next to each individual
#dataCon <- dplyr::full_join(dfPCL5_toBinarize, countCon)
