...
est = estimate_xmin(m_pl) ## Estiamte parameters
...
```{r}
m_pl5 = displ$new(countFreqBigPCL5_nonBinar$freq)
...
```{r}
bs_p5 = bootstrap_p(m_pl5, no_of_sims = 500, threads = 8)
bs_p5$p
plot(bs_p5)
```

### Non binary distribution doesn't follow power law at all
